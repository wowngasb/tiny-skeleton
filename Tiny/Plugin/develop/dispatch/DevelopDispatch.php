...
class DevelopDispatch implements DispatchInterface
{
    ...
    {
        return Application::initMethodName($routeInfo);
    }
    ...
    public static function initMethodNamespace(array $routeInfo)
    {
        ...
        $module = !empty($routeInfo[0]) ? Func::trimlower($routeInfo[0]) : 'develop';
