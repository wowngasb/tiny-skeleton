...
<hr/>
<?= $view->widget($response, 'widget/index/test-widget.php', ['list' => ['item 1', 'item 2', 'item 3'], 'title' => 'TEST']) ?>
</body>
...
</script><?= \Tiny\Plugin\Fis::scriptEnd($response, 0) ?>
